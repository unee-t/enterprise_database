...
# What are the version of the Unee-T BZ Database schema BEFORE and AFTER this update?
	...
	SET @old_schema_version := 'v1.21.3';
	SET @new_schema_version := 'v1.21.4';
...
#	- ALL lambda call include a `mefeAPIRequestId`
#	- `mefeAPIRequestId` is a VARCHAR and is a UUID.
#	- We can get the reply from the MEFE and record that in the Unee-T Database
#
# - Create new tables
#	- ``
#	- ``
