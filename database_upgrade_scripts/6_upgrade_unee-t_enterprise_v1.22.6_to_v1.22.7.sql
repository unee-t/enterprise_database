...
# What are the version of the Unee-T BZ Database schema BEFORE and AFTER this update?
	...
	SET @new_schema_version := 'v1.22.7_alpha_3';
...
# Alter the table `ut_map_external_source_units`
...
# We can now check if the conditions are met:
	...
	# The conditions are met: we capture the other variables we need
		...
		SET @this_trigger_update_extl1 = 'ut_update_external_property_level_1';

		SET @syst_created_datetime_update_extl1 = NOW();
		...
		SET @syst_updated_datetime_update_extl1 = NOW() ;
		...
		THEN 
			...
			# This is option 1 - creation IS needed
				...
				SET @this_trigger_update_extl1 = 'ut_update_external_property_level_1_creation_needed' ;
				SET @downstream_creation_method_update_extl1 = @this_trigger_update_extl1 ;
				SET @downstream_update_method_update_extl1 = @this_trigger_update_extl1 ;
			...
			# We do this via INSERT INTO ... ON DUPLICATE KEY UPDATE for maximum safety
				...
				INSERT INTO `property_level_1_buildings`
					...
					VALUES
						...
						, @syst_created_datetime_update_extl1
						, @creation_system_id_update_extl1
						, @created_by_id_update_extl1
						, @downstream_creation_method_update_extl1
					...
					ON DUPLICATE KEY UPDATE
						`syst_updated_datetime` = @syst_updated_datetime_update_extl1
						, `update_system_id` = @update_system_id_update_extl1
						, `updated_by_id` = @updated_by_id_update_extl1
						, `update_method` = @downstream_update_method_update_extl1
...
#
	...
	SET @id_in_ut_map_external_source_units_insert_l1_1 = (SELECT `id_map`
		...
		WHERE `external_property_type_id` = @external_property_type_id_insert_l1_1
	...
	#	- the record is marked as obsolete
		...
		SET @do_not_insert_insert_l1_1_raw = NEW.`do_not_insert` ;
	...
	# We capture the values we need for the insert/udpate:
		...
		SET @this_trigger_insert_l1_1 = 'ut_insert_map_external_source_unit_add_building' ;
		...
		SET @unee_t_unit_type_insert_l1_1_raw = NEW.`unee_t_unit_type` ;

		SET @unee_t_unit_type_insert_l1_1 = (IFNULL(@unee_t_unit_type_insert_l1_1_raw
				, 'Unknown'
				)
			)
			;
	...
	# The conditions are met: we capture the other variables we need
		...
		THEN 
			...
			# This is option 1 - creation IS needed
				...
				SET @this_trigger_update_l1 = 'ut_update_map_external_source_unit_add_building_creation_needed' ;
				SET @creation_method_update_l1 = @this_trigger_update_l1 ;
				SET @update_method_update_l1 = @this_trigger_update_l1 ;
			...
			# We insert/Update a new record in the table `ut_map_external_source_units`
				...
				INSERT INTO `ut_map_external_source_units`
					...
					VALUES
						(@syst_created_datetime_update_l1
						, @creation_system_id_update_l1
						, @created_by_id_update_l1
						, @this_trigger_update_l1
					...
					ON DUPLICATE KEY UPDATE
						`syst_updated_datetime` = @syst_updated_datetime_update_l1
						, `update_system_id` = @update_system_id_update_l1
						, `updated_by_id` = @updated_by_id_update_l1
						, `update_method` = @this_trigger_update_l1
...
###################################################################
		...
		THEN 
			...
			# This is option 2 - creation is NOT needed
				...
				SET @this_trigger_update_l1 = 'ut_update_map_external_source_unit_edit_level_1' ;
				SET @creation_method_update_l1 = @this_trigger_update_l1 ;
				SET @update_method_update_l1 = @this_trigger_update_l1 ;
...
#
	...
	THEN 
		...
		# We capture the values we need for the insert/udpate:
			...
			SET @this_trigger_insert_l2 = 'ut_insert_map_external_source_unit_add_unit' ;
